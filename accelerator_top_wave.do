...
add wave -noupdate -radix unsigned /accelerator_top_testbench/max_val
add wave -noupdate -radix unsigned /accelerator_top_testbench/max_index
add wave -noupdate /accelerator_top_testbench/dut/all_write_done
...
add wave -noupdate /accelerator_top_testbench/dut/cur_features
...
add wave -noupdate -group {Encode Control} -radix unsigned /accelerator_top_testbench/dut/encode_control/projection_addrs
add wave -noupdate -group {Encode Control} -radix unsigned /accelerator_top_testbench/dut/encode_control/feature_addrs
add wave -noupdate -group {Encode Control} /accelerator_top_testbench/dut/encode_control/out_done
add wave -noupdate -group {Encode Control} /accelerator_top_testbench/dut/encode_control/out_reset
add wave -noupdate -group {Encode Control} /accelerator_top_testbench/dut/encode_control/cur_encode_done
add wave -noupdate -group {Encode Control} /accelerator_top_testbench/dut/encode_control/reset_in
add wave -noupdate -group {Encode Control} /accelerator_top_testbench/dut/encode_control/write_data_done
add wave -noupdate -group {Encode Control} /accelerator_top_testbench/dut/encode_control/vertical_projection_mem_loc
add wave -noupdate -group {Encode Control} /accelerator_top_testbench/dut/encode_control/horizontal_projection_mem_loc
add wave -noupdate -group {Encode Control} /accelerator_top_testbench/dut/encode_control/encoding_cycle_count
...
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/class_in
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/read_address
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/we
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/re
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/write_done
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/class_out
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/address_in
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/write_address
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/total_count_write
add wave -noupdate -group Classes /accelerator_top_testbench/dut/class_mem/i
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/class_addrs
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/reset_out
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/out_done
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/reset_in
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/write_data_done
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/cur_encode_done
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/class_num
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/cur_class_addr
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/encoding_cycle_count
add wave -noupdate -group {Class_Check Controller} /accelerator_top_testbench/dut/class_check_control/total_count
